...
import { ArrowRight, Landmark, FileText, MessageSquare, Users, Store, Scale, Gavel, ShieldCheck } from 'lucide-react';
...
const services = [
  ...
  { name: 'Negócios Livres', description: 'Marketplace completo para compra, venda e negociação entre cidadãos', icon: Store, path: '/services/business', color: 'text-blue-400' },
  ...
  { name: 'Sistema Penal', description: 'Consulte registros criminais e status de sentenças da comunidade.', icon: Gavel, path: '/services/penal-system', color: 'text-amber-400' },
  { name: 'Forças Armadas', description: 'Defenda a soberania e a segurança da nação.', icon: ShieldCheck, path: '/services/armed-forces', color: 'text-emerald-400' },
];
  ...
  return (
    <section id="services-section" className="py-24 bg-background/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">Principais <span className="gradient-text">Serviços</span></h2>
