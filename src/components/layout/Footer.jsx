...
import { Github, Mail, Heart, HelpCircle, Headphones as Headset, BookOpen, Newspaper, Landmark, Store, FileText, Users, Scroll, ArrowRight, Home as HomeIcon, Milestone } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-12">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-1">
            {/* LOGO ATUALIZADO PARA FICAR IGUAL AO DA NAVBAR */}
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <Link to="/services/business" className={footerLink}><Store className="w-4 h-4"/> Negócios Livres</Link>
        ...
        <div className="border-t border-white/10 mt-12 pt-8">
          ...
          <div className="flex items-center justify-center mt-6">
            <p className="text-gray-500 text-sm flex items-center">
              Feito com 
              <motion.span whileHover={{ scale: 1.5 }} className="inline-block mx-1.5">
                <Heart className="w-4 h-4 text-red-500/80 drop-shadow-[0_0_3px_rgba(239,68,68,0.8)]" />
              </motion.span>
               para a comunidade de RP
            </p>
          </div>
        </div>
      </div>
