...
const Community = () => {
  const channels = [
    {
      name: 'WhatsApp',
      description: 'Participe do nosso grupo principal para discussões rápidas, anúncios e interação diária com a comunidade.',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Junte-se à comunidade do GOV.RP! Conecte-se com outros jogadores no WhatsApp e Discord, participe de eventos e faça parte da nossa nação." />
      </Helmet>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              O coração do GOV.RP são nossos cidadãos. Conecte-se, colabore e faça parte de uma comunidade vibrante e apaixonada por roleplay político.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {channels.map((channel, index) => (
              ...
              >
                <a href={channel.link} target="_blank" rel="noopener noreferrer" className="block glass-effect rounded-2xl p-8 h-full hover:bg-white/10 transition-all duration-300 group">
