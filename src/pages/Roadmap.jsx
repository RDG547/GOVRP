...
import { CheckCircle, Milestone, Clock, Zap, Target, Rocket, Users, Shield, Globe, Code, Sparkles } from 'lucide-react';
...
const Roadmap = () => {
  ...
  const roadmapItems = [
    ...
    {
      phase: 'Fase 2',
      period: '2º Trimestre de 2025',
      status: 'completed',
      title: 'Desenvolvimento dos Principais Sistemas',
      ...
      items: [
        ...
        'Departamento de Identificação Civil com emissão de documentos',
        'Négocios Livre com sistema de compra e venda',
        'Rede Social X com interação em tempo real',
      ]
    },
    {
      phase: 'Fase 3',
      period: '3º Trimestre de 2025',
      status: 'in-progress',
      title: 'Expansão dos Serviços',
      description: 'Adição de novos serviços e funcionalidades avançadas.',
      items: [
        'Melhorias nos principais sistemas com inclusão de diversas novas funcionalidades',
        'Inclusão de diversos novos serviços expandindo para um total de 21',
        'Revisão e correções de erros nos sistemas já existentes',
        'Otimização de performance e segurança',
      ]
    },
    {
      phase: 'Fase 4',
      period: '4º Trimestre de 2025',
      status: 'planned',
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-white mb-2">2 Fases</h3>
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-white mb-2">3º Fase</h3>
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-white mb-2">5 Fases</h3>
