...
const AdminDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      if (statsResponse.data) setStats(statsResponse.data[0] || {});
                      ...
                      <div key={user.id} className="flex items-center justify-between p-4 rounded-lg bg-slate-800/50">
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-green-400">{formatCurrency(user.balance || 0)}</p>
                      ...
                      <div key={post.id} className="flex items-start justify-between p-4 rounded-lg bg-slate-800/50">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-sm text-gray-400">{post.created_at ? new Date(post.created_at).toLocaleString('pt-BR') : 'Data inválida'}</span>
                          </div>
              ...
              <form onSubmit={(e) => {
                ...
                <div className="space-y-4 py-4">
                  ...
                  <div>
                   ...
                   <div>
                    <Label htmlFor="titles">Títulos (separados por vírgula)</Label>
                    <Input id="titles" name="titles" defaultValue={selectedUser.titles?.join(', ')} />
                  </div>
                </div>
                <DialogFooter>
